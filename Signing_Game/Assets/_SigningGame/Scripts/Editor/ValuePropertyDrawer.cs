...
namespace SigningGame.Editor.Signatures {
    ...
    public sealed class ValuePropertyDrawer : PropertyDrawer {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            storedProperty.doubleValue = Math.Max(0d,
                EditorGUI.DoubleField(storedRect, GUIContent.none, storedProperty.doubleValue));
            degreeProperty.intValue = Mathf.Max(0,
                EditorGUI.IntField(degreeRect, GUIContent.none, degreeProperty.intValue));

            var previewRect = new Rect(inputRect.x, inputLine.yMax + _PreviewSpacing, inputRect.width, lineHeight);
            EditorGUI.LabelField(previewRect, FormatPreview(storedProperty.doubleValue, degreeProperty.intValue),
        ...
        private static string FormatPreview(double stored, int degree) {
            ...
            var value = new Value(safeStored, new BaseValue { Degree = safeDegree });
