...
namespace Utils {
    ...
    public class Value : IComparable<IValue>, IEquatable<IValue>, IValue {
        ...
        public BaseValue Base => _base;
        public bool IsZero => _stored <= 0d;

        public Value(double stored, BaseValue baseValue) {
            _stored = stored;
            _base = baseValue;
            Normalize();
        }
        ...
        public Value(double value) {
            ...
            _base = new BaseValue { Degree = degree };
            Normalize();
        }
        ...
        public static Value FromLog10(double log10Value) {
            ...
            return new Value(stored, new BaseValue { Degree = degree });
        }
        ...
        public int CompareTo(IValue other) {
            if (_base.Degree == other.Base.Degree) {
                return _stored.CompareTo(other.Stored);
            }

            return _base.Degree.CompareTo(other.Base.Degree);
        }

        public bool Equals(IValue other) {
            return _base.Degree == other?.Base.Degree && _stored.Equals(other.Stored);
        }
        ...
        public bool IsSignificant(Value other) => _base.Degree - other._base.Degree < _MaxBaseDifference;
    }
